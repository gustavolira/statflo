...
import com.statflo.api.repository.mongodb.LogExceptionRepository;

@ControllerAdvice
public class CustomRestExceptionHandler extends ResponseEntityExceptionHandler {

	@Autowired
	private LogExceptionRepository logRepository;
	// 400
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(final MethodArgumentNotValidException ex,
		...
		LogException log = new LogException(apiError, "handleMethodArgumentNotValid");
